...
```{r}
spatial_data <- readRDS("data/ACH005/ACH005.rds")
...
```{r message=FALSE}
ref_data <- readRDS("data/hca_p14.rds")
...
run_misty(heart_views, "data/result/vignette_structural_pipeline")

misty_results <- collect_results("data/result/vignette_structural_pipeline")
```
